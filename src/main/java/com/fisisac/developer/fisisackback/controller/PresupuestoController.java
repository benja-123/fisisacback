...
public class PresupuestoController{
    ...
    @GetMapping
    public ResponseEntity<Presupuesto> getPresupuesto(@PathVariable(name = "nconsejo") String nconsejo){
        Presupuesto presupuesto = presupuestoService.getPresupuestoByNConsejo(nconsejo);
